...
/**
 * Class which contains cards. - handles card limit - remove/add card
 */
public class CardContainer {
	...
	public CardContainer(ArrayList<Card> cards, int cardLimit) throws IllegalArgumentException {
		...
		if (cards.size() > cardLimit)
			throw new IllegalArgumentException("The number of cards exceeds the limit. Maximum number of cards: "
					+ cardLimit + ", got " + cards.size());
	...
	/**
	 * Default constructor. Initialize cards with empty arraylist. Unlimited card
	 * number
	 */
