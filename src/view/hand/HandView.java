...
////this.hero.draw();
	...
	public void update() {
		...
		// Container
		this.handContainer = new JPanel();
		this.handContainer.setLayout(new FlowLayout());
		this.handContainer.setBackground(Color.DARK_GRAY);
		
		this.cardContainer = new JPanel();
		this.cardContainer.setLayout(new FlowLayout(FlowLayout.CENTER));
		this.cardContainer.setBackground(Color.DARK_GRAY);
		...
		this.handContainer.add(new DeckView(this.hero.getDeck()));
		this.handContainer.add(cardContainer);
		this.handContainer.add(new SkipTurn(this.hero));
