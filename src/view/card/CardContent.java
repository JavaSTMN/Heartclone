...
public class CardContent extends JLabel {
	...
	public void paintComponent(Graphics g) {
	    ...
	    g.drawImage(cristalImage, 0, 20, 25, 25, this);
	    g.drawImage(attackImage, 0, 150, 35, 35, this);
	    g.drawImage(lifeImage, 100, 150, 25, 35, this);

	    if(g instanceof Graphics2D)
	    {
	        Graphics2D g2d = (Graphics2D)g;
	        //g2d.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_ON);
	        g2d.drawString(cristalCost.toString(), 35, 35);
	    }
	  }
